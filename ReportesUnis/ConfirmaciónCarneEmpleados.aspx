<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConfirmaciónCarneEmpleados.aspx.cs" Inherits="ReportesUnis.ConfirmaciónCarneEmpleados" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        <br />
        <h2 style="text-align: center;">CARNETIZACIÓN EMPLEADOS</h2>
    </div>
    <hr />
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <br />
                                                    <asp:TextBox ID="TxtPuestoAC" runat="server" Enabled="false" Width="300px"></asp:TextBox>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    ...
                                                    <br />
                                                    <asp:TextBox ID="TxtRolAC" runat="server" Enabled="false" Width="300px"></asp:TextBox>
                                                </div>
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <asp:Label runat="server" Font-Bold="true">PUESTO:</asp:Label>
                                                    <br />
                                                    <asp:TextBox ID="TxtPuestoPC" runat="server" Enabled="false" Width="300px"></asp:TextBox>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <asp:Label runat="server" Font-Bold="true">ROL:</asp:Label>
                                                    <br />
                                                    <asp:TextBox ID="TxtRolPC" runat="server" Enabled="false" Width="300px"></asp:TextBox>
                                                </div>
                                        ...
                                        <div class="container">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-4">
                                                    <asp:Label runat="server" Font-Bold="true">PUESTO:</asp:Label>
                                                    <br />
                                                    <asp:TextBox ID="TxtPuestoRC" runat="server" Enabled="false" Width="300px"></asp:TextBox>
                                                </div>
                                                ...
                                                <div class="form-group col-md-4">
                                                    <asp:Label runat="server" Font-Bold="true">ROL:</asp:Label>
                                                    <br />
                                                    <asp:TextBox ID="TxtRolRC" runat="server" Enabled="false" Width="300px"></asp:TextBox>
                                                </div>
