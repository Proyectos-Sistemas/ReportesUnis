...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div>
            ...
            <asp:DropDownList ID="LbxBusqueda2" runat="server" SelectionMode="Single" AutoPostBack="true" EnableViewState="true" Visible="false" OnSelectedIndexChanged="LbxBusqueda2_SelectedIndexChanged">
            </asp:DropDownList>
        ...
        <asp:Table runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; align-content: center">
            <asp:TableRow>
                <asp:TableCell>
                    <asp:Button ID="BtnBuscar" runat="server" Text="Buscar" OnClick="BtnBuscar_Click" CssClass="btn-danger-unis"></asp:Button>
                </asp:TableCell>
                <asp:TableCell>
        ...
        <div class="containerGV" id="GVContainer">
            <asp:GridView ID="GridViewReporte" runat="server"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Cumpleaños" HeaderText="FECHA DE NACIMIENTO" />
                    ...
                    <asp:BoundField DataField="" HeaderText="PAIS_PASS" />
                    ...
                    <asp:BoundField DataField="Dependencia" HeaderText="FACULTAD" />
