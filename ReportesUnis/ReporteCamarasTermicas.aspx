    ...
    <div class="container">
        ...
        <asp:Table runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; align-content: center">
            <asp:TableRow>
                ...
                <asp:TableCell>
                    <asp:Button ID="BtnTxt" runat="server" Text="Exportar Excel" OnClick="GenerarExcel" CssClass="btn-danger-unis"></asp:Button>
                </asp:TableCell>
                <asp:TableCell>
                    <asp:Button ID="BtnImg" runat="server" Text="Exportar Imagenes" OnClick="BtnImg_Click" CssClass="btn-danger-unis"></asp:Button>
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
