<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LogInterfazHCMCS.aspx.cs" Inherits="ReportesUnis.LogInterfazHCMCS"  %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <br />
    <div style="margin-left: auto; margin-right: auto; text-align: center;">
    <asp:Label Text="Reporte de log Interfaz HCM-Campus" runat="server" CssClass="h3" />
        </div>
    <br />
    <div class="container">
        <div class="row">
