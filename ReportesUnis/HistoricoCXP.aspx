<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="HistoricoCXP.aspx.cs" Inherits="ReportesUnis.HistoricoCXP"  %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

        <br />
                    <h2 style="text-align:center;">
                   Históricos Cuentas por pagar</h2>
        <hr />
        <br />
        <div class="container">
            <div class="row">
                 ...
                 <div class="form-group col-md-4">
                    <asp:Label Text="Código de proveedor" for="CodigoProveedor" runat="server" />
                    <asp:TextBox ID="CodigoProveedor" CssClass="form-control" runat="server" autocomplete="off"></asp:TextBox>
                </div>
                 <div class="form-group col-md-4">
                    ...
                    <div class="col-md-12" >
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-condensed table-bordered"  OnRowCommand="GridView1_RowCommand"  DataKeyNames="code" ShowHeaderWhenEmpty="true" >
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Código proveedor">
                                    <ItemTemplate>
                                        <div style="width: 125px;">
                                            <%# Eval("codeproveedor")%>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="profile-head">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <h6>
                                                              <b>Nit:</b> <span id="NitProveedor"></span>
                                                            </h6>
                                                            <h6>
                                                               <b>Razón social:</b> <span id="RazonSocialProveedor"></span>
                                                            </h6>
                                                             <h6>
                                                               <b>Unidad de negocio:</b> <span id="UnidadNegocioProveedor"></span>
                                                            </h6>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <h6>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <table class="table" id="tblDetalleCXP">
                                                                      <thead>
                                                                        <tr>
