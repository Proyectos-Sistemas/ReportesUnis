<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LogInterfazCC.aspx.cs" Inherits="ReportesUnis.LogInterfazCC"  %>
<%@ Register Assembly="Microsoft.ReportViewer.WebForms" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <br />
    <div style="margin-left: auto; margin-right: auto; text-align: center;">
    <asp:Label Text="Reporte de log Interfaz CRM-Campus" runat="server" CssClass="h3" />
        </div>
    <br />
    <div class="container">
        <div class="row">
...
<%--            <div class="form-group col-md-4 mb-3">
                ...
                <asp:DropDownList ID="DropDownListTipo" runat="server" CssClass="form-control" required>
                    ...
                    <asp:ListItem Value="2">Correcto</asp:ListItem>
