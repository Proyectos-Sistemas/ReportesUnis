...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Actualización" class="tabcontent">
        ...
        <div class="container" runat="server">
            <asp:Table ID="TbEliminarD" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; align-content: center">
                ...
                <asp:TableRow>
                    <%-- ESPACIO 2.1--%>
                    <asp:TableCell>
                        <asp:Button ID="BtnEliminarAC" runat="server" Text="Rechazar Seleccionados" CssClass="btn-danger-unis" Enabled="true" OnClientClick="return mostrarAlertaEliminar()" OnClick="ButtonSubmitAC_Click" />
                    </asp:TableCell>
                    <%-- ESPACIO 2.2--%>
                    <asp:TableCell>
                        <asp:Button ID="BtnConfirmarAC" runat="server" Text="Confirmar" CssClass="btn-danger-unis" Enabled="true" OnClientClick="return mostrarAlertaConfirmar()" OnClick="BtnConfirmarAC_Click" />
                    </asp:TableCell>
                </asp:TableRow>
                <asp:TableRow>
                    <%-- ESPACIO 3--%>
