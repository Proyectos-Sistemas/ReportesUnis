...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="CamposAuxiliares" runat="server" visible="true">
        ...
        <asp:TextBox ID="prueba" runat="server" Visible="true"></asp:TextBox>
    ...
    <div class="container" runat="server">
        <asp:Table ID="TbEliminarD" runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; align-content: center">
            ...
            <asp:TableRow>
                <%-- ESPACIO 2.1--%>
                <asp:TableCell>
                    <asp:Button ID="BtnEliminar" runat="server" Text="Rechazar Seleccionados" CssClass="btn-danger-unis" Enabled="true" OnClick="ButtonSubmit_Click" />
                </asp:TableCell>
                <%-- ESPACIO 2.2--%>
                <asp:TableCell>
                    <asp:Button ID="BtnConfirmar" runat="server" Text="Confirmar" CssClass="btn-danger-unis" Enabled="false" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <%-- ESPACIO 3--%>
