        ...
        <div>
            ...
            <asp:Table runat="server" Style="margin-left: auto; margin-right: auto; text-align: center; align-content: center" CssClass="table-condensed ">
                ...
                <asp:TableRow HorizontalAlign="Center">
                    ...
                    <%-- DIRECCION TEXTBOX 4--%>
                    <asp:TableCell>
                        <asp:TextBox ID="txtDireccion" runat="server" TextMode="MultiLine" Rows="3" MaxLength="240"></asp:TextBox>
                    </asp:TableCell>
                    <%-- ESPACIO 5--%>
                    <asp:TableCell Width="5%">
                        <br />
                    ...
                    <asp:TableCell>
                        <asp:TextBox ID="txtDireccion2" runat="server" TextMode="MultiLine" Rows="3" MaxLength="240"></asp:TextBox>
                    </asp:TableCell>
                    <%-- ESPACIO 9--%>
                    <asp:TableCell>
                        <br />
                    ...
                    <%-- ZONA TEXTBOX 12--%>
                    <asp:TableCell>
                        <asp:DropDownList ID="txtZona" runat="server" AutoPostBack="true" EnableViewState="true" >
                        </asp:DropDownList>
                    </asp:TableCell>
                    <%-- ESPACIO 13--%>
                    <asp:TableCell Width="5%">
                ...
                <asp:TableRow HorizontalAlign="Center">
                    ...
                    <%-- TELEFONO TEXTBOX 12--%>
                    <asp:TableCell>
                        <asp:TextBox ID="txtTelefono" runat="server" MaxLength="60"></asp:TextBox>
                    </asp:TableCell>
                    <%-- ESPACIO 13--%>
                    <asp:TableCell>
                        <br />
